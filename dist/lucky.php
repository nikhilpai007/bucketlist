...
<html lang="en-CA">
	<head>
		<?php
			$PAGE_TITLE = "Kick It! | I'm Feeling Lucky";
  ...
  <body id="lucky-page">
    ...
    <main>
      <?php 
        $query = "SELECT * FROM project_lists WHERE visibility = 1 ORDER BY RAND() LIMIT 1;";
      ...
      <button name="feeling-lucky-btn" type="submit" onclick="window.location.href='./lucky.php'">I'm Feeling Lucky</button>
